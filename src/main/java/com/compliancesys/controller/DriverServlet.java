...
public class DriverServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        // TODO: Injetar DriverService e GsonSerializer (ex: via CDI/Spring ou instanciar diretamente para este exemplo)
        // Por simplicidade, instanciando diretamente para o exemplo. Em um projeto real, use injeção de dependência.
        // As implementações concretas de DriverService e GsonSerializer precisarão ser fornecidas aqui.
        this.driverService = null; // Substituir pela implementação real
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (pathInfo == null || pathInfo.equals("/")) {
            ...
            try {
                // TODO: Garantir que driverService não é nulo antes de usar
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            // TODO: Garantir que gsonSerializer não é nulo antes de usar
